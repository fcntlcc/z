#ifndef Z_RPC_SERVER_FRAMEWORK_H__
#define Z_RPC_SERVER_FRAMEWORK_H__

#include "../low/znet.h"
#include "../low/zmem.h"
#include "../low/ds.h"
#include "../low/multi_thread.h"
...
struct RPCServiceHandle {
    typedef z::low::net::socket_fd_t                socket_fd_t;
    typedef z::low::ds::StaticLinkedList<RPCTask>   task_pool_t;
    typedef z::low::ds::FixedLengthQueue<RPCTask*, 
            z::low::multi_thread::ZSpinLock>        task_queue_t;
