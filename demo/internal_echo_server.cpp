...
void run(Params &pa) {
    ...
    info.server_task_pair_num = 1024;
    ...
    InternalEchoServer echo_server;
    InternalServerTask *tasks = new InternalServerTask[info.server_task_pair_num];
